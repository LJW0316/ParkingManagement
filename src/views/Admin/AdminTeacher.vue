<template>
  <div style="padding: 10px">
    ...
    <!--    搜索区域-->
    <div style="margin: 10px 0">
      <el-input v-model="search" placeholder="请输入教师号" style="width: 20%" clearable/>
      ...
      >
        <el-form :model="form" label-width="120px">
          ...
          <el-form-item label="职称">
            <el-radio v-model="form.tclass" label="系统管理员">系统管理员</el-radio>
            <el-radio v-model="form.tclass" label="教师">教师</el-radio>
          </el-form-item>
        </el-form>
        <template #footer>
  ...
  methods:
      {
        ...
        save() {
          ...
          if (add_bool == true)//新增
          {
            axios.post('/teacher', this.form).then(res => {
              console.log(res)
          ...
          {
            axios.put('/teacher', this.form).then(res => {
              console.log(res)
        ...
        handleDelete(tno) {
          console.log(tno)
          axios.delete('/teacher/' + tno).then(res => {
